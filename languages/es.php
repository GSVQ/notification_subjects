...
$spanish = array(
    ...
    'notification_subjects:event:create' => "ha creado un",
    'notification_subjects:event:delete' => "ha borrado el",
    'notification_subjects:event:update' => "ha actualizado el",
    'notification_subjects:group' => "en el grupo '%s'",
